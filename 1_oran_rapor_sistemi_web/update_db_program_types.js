...
async function main() {
  await prisma.systemSetting.upsert({
    where: { key: 'PROGRAM_TYPES' },
    update: { value: JSON.stringify(PROGRAM_TYPES) },
    create: { key: 'PROGRAM_TYPES', value: JSON.stringify(PROGRAM_TYPES) }
  });
  console.log(`Updated PROGRAM_TYPES with ${PROGRAM_TYPES.length} items in DB successfully.`);
}
